...
policy choices (ADR 0003 informational E-Verify, a longer one-time Gmail backfill) must not change what the specification
...
def _specification_policy_env(monkeypatch):
    ...
    monkeypatch.setenv("GMAIL_BACKFILL_DAYS", "30")
